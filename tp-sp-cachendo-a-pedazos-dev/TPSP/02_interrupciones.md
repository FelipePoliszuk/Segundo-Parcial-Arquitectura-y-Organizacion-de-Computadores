...
```
El selector que usamos es el de codigo nivel 0. El valor de los atributos es 0xE que corresponde 
a una interrumpt gate de 32 bits.
```
...
```
El prologo seria el pushad, y popad el epilogo. Usamos iret ya que interrumpimos una tarea y esta 
instruccion devuelve mas informacion que 'ret'.
```
