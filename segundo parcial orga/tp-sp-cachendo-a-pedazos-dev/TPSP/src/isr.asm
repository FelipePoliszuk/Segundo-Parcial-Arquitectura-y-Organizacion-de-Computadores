...
global _isr14
_isr14:
    ; En CR2 debería estar la dirección que generó el page fault
    ; pushad
    ; mov EAX, CR2
    ; push EAX
    ; call page_fault_handler ; Tiene como parámetro la dirección virtual del fault
    ; add ESP, 4
    ; popad
    ; add ESP, 4
    ; iret
