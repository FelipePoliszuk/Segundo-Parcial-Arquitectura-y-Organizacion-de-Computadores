...
#define SIZE_FLAT 1024 * 1024 * 817
#define SIZE_VIDEO 80 * 50 * 2
...
#define FLAT_SEGM_SIZE   GDT_LIMIT_4KIB(SIZE_FLAT) 
#define VIDEO_SEGM_SIZE  GDT_LIMIT_BYTES(SIZE_VIDEO)
